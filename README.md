...
Volitelně (Beta) **High-res FFT 150–270 Hz** a **25–150 Hz** (Goertzel DFT bins po 1 Hz, záznam každých 3 s) — další spektrogramy v dashboardu.
...
| **High-res FFT 150–270 Hz (Beta)** | skutečné 1 Hz biny (DFT), sloupec ≈ 3 s; tabulka `spectrum_fine_3s` |
| **High-res FFT 25–150 Hz (Beta)** | totéž v basu (50 Hz síť, 25/63 Hz VZT); tabulka `spectrum_fine_lf_3s` |
...
> BETA grafy: **DFT/FFT biny** 150–270 a 25–150 Hz (komponenta `hlukomer_fine_fft`).
...
| `GET /api/v1/spectrum/fine/history?hours=6` | high-res FFT 150–270 Hz (1 Hz / 3 s) |
| `GET /api/v1/spectrum/fine-lf/history?hours=6` | high-res FFT 25–150 Hz (1 Hz / 3 s) |
