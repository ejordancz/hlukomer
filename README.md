...
Volitelně (Beta) **High-res FFT 170–270 Hz** a **25–70 Hz** (Goertzel DFT bins po 1 Hz, záznam každých 3 s) — další spektrogramy v dashboardu.
...
| **High-res FFT 170–270 Hz (Beta)** | skutečné 1 Hz biny (DFT), sloupec ≈ 3 s; tabulka `spectrum_fine_3s` |
...
> BETA grafy: **DFT/FFT biny** 170–270 a 25–70 Hz (komponenta `hlukomer_fine_fft`).
...
| `GET /api/v1/spectrum/fine/history?hours=6` | high-res FFT 170–270 Hz (1 Hz / 3 s) |
