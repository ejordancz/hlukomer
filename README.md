...
Volitelně (Beta) **High-res FFT 190–270 Hz** a **25–70 Hz** (Goertzel DFT bins po 1 Hz, záznam každých 3 s) — další spektrogramy v dashboardu.
...
| **High-res FFT 190–270 Hz (Beta)** | skutečné 1 Hz biny (DFT), sloupec ≈ 3 s; tabulka `spectrum_fine_3s` |
...
> BETA grafy: **DFT/FFT biny** 190–270 a 25–70 Hz (komponenta `hlukomer_fine_fft`).
